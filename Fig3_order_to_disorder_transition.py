...
#%% SCattering ensemble simulation 

N_ens = 10000

k_list = omega_b * np.linspace(0.85, 1.15, 201)
...
np.savetxt('Data_Fig3_bandwidth_fw_fine.csv', np.real(P_fw_ens_total), delimiter=' ')
np.savetxt('Data_Fig3_bandwidth_bw_fine.csv', np.real(P_bw_ens_total), delimiter=' ')
