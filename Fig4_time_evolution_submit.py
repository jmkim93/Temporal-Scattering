...
fig.tight_layout()
fig.savefig('fig4_filter_application_test_sq.png', dpi=1200, format='png')
fig.savefig('fig4_filter_application_test_sq.pdf', dpi=1200, format='pdf')
...
fig_cb.savefig('fig4_filter_application_test_sq_cb.pdf', dpi=1200, format='pdf')
...
anim.save('fig4_application_test_sq_ver3.gif', fps=40, dpi=300)
